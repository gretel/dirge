...
| `context_depth_reminder_threshold` | integer | Consecutive same-file turns before a single mid-turn reminder restates the active task + touched files. Opt-in; unset (default) disables. Recommended value: `8`. |
